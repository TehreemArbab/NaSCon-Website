...
public partial class editExec : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            string command = "select * from Student_Executives where execID = '" + Application["EditExecUsername"].ToString() + "'";
    ...
    protected void SaveEdit(object sender, EventArgs e)
    {
        ...
        string command = "UPDATE Student_Executives SET fname = '" + Fname.Text + "', lname = '" + Lname.Text + "', roleID = " + RoleSelect.SelectedValue + " where execID = " + Application["EditExecUsername"].ToString() + "";
