<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editExec.aspx.cs" Inherits="editExec" %>
...
<head runat="server">
    <title>Create Exec Account</title>
    ...
    <form runat="server" id="NewAdminForm" style="margin: 40px 10%">
            ...
            >
                <div style="display: flex; flex-direction: column; gap: 16px">
                    <h3 style="margin-bottom: 16px">Edit Executive</h3>
                    <div class="textField">
                    ...
                    <div class="textField">
                        ...
                        <asp:DropDownList ID="BatchSelect" runat="server" class="input" disabled>
